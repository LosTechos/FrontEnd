...
class RegUserHouse extends Component {
  ...
  peticionPost = async () => {
    await axios.post(url + "userRegister", this.state.form, {
      headers: {
  ...
  peticionPostH = async () => {
    await axios.post(url + "houseRegister", this.state.form, {
      headers: {
        'access-token': localStorage.getItem("access-token")
      }
    }).then(response => {
...
peticionPost=async()=>{
await  axios.post(url+"userRegister",this.state.form,{headers:{
  'access-token': localStorage.getItem("access-token")
}}).then(response=>{
    this.modalInsert();
  }).catch(error=>{
...
peticionPostH=async()=>{
  await  axios.post(url+"houseRegister",this.state.form,{headers:{
    'access-token': localStorage.getItem("access-token")
  }}).then(response=>{
      this.modalInsert();
    }).catch(error=>{
